...
# Song Swap : song recommendations from real people
# Deployment Link: https://song-swap-flask-1d01e13571da.herokuapp.com/
...
**Instructions:**
- SPOTIPY: before you are able to run code involving Spotipy, you must authorize using the SPOTIPY_CLIENT_ID, SPOTIPY_CLIENT_SECRET, and SPOTIPY_REDIRECT_URI (https://localhost:5000/callback) of the app that you must create to run (look below for how to create)
